...
# ============================================================
# HertzifyOS Peridot Build Script
# ============================================================
...
# -----------------------------
ROM_NAME="HertzifyOS"
ROM_URL="https://github.com/HertzifyOS/android_manifest.git"
ROM_BRANCH="17"
...
LUNCH_TARGET="hertzify_peridot-cp2a-user"
...
description() {
    ...
    echo -e "${CYAN}${BOLD}├────────────────────────────────────────────────────────────┤${RESET}"
    echo -e "${CYAN}│${RESET} HertzifyOS automated build and release script for           ${CYAN}│${RESET}"
...
notify_build_start() {
    ...
    tg_send "🚀 HertzifyOS build started
...
notify_build_failed() {
    ...
    tg_send "❌ HertzifyOS build FAILED
...
notify_finished() {
    ...
    tg_send "🏁 HertzifyOS build finished
...
section "Initializing HertzifyOS"
...
ok "HertzifyOS repository initialized"
...
echo "│ Variant    : user                                          │"
echo "│ Build cmd  : lunch hertzify_peridot-cp2a-user                        │"
echo "╰────────────────────────────────────────────────────────────╯"
echo -e "${RESET}"

info "Build command: lunch hertzify_peridot-cp2a-user"

ok "HertzifyOS target configured"
...
section "Building HertzifyOS"

BUILD_START=$(date +%s)

if lunch hertzify_peridot-cp2a-user; then
...
ok "HertzifyOS build successful"
info "Build time: ${BUILD_MINUTES} minutes"
...
info "Searching for the final HertzifyOS ZIP (target_files and OTA helper ZIPs excluded)"
...
if [[ ${#ARTIFACTS[@]} -eq 0 ]]; then
    ...
    tg_send "⚠️ HertzifyOS build completed
