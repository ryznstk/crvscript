...
banner() {
    ...
    echo "║                    HERTZIFYOS                              ║"
    echo "║                                                            ║"
    echo "║              Automated Build & Release                     ║"
    echo "║                                                            ║"
    echo "║  Device : POCO F6 / peridot                               ║"
    echo "║  Target : hertzify_peridot-cp2a-user                      ║"
    echo "║  Build  : mka bacon                                       ║"
    echo "║                                                            ║"
    echo "╚════════════════════════════════════════════════════════════╝"
    echo -e "${RESET}"
}
...
info "Keeping existing out/ build state"
info "Running: make installclean"

make installclean || {
    fail "make installclean failed"
    exit 1
}
